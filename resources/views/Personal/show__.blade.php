...
@section('content')
 ...
 <div class="container">
 <h1>Дільниці {{$personal->name}}<img width="100px" src="http://election/img/tent.png"><a href="{{route('export.export_personals_',$personal)}}" class="btn btn-primary">Друк</a></h1>
      <table class="table">
